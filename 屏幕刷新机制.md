...
private final class FrameDisplayEventReceiver extends DisplayEventReceiver
    ...
    public void run() {
        ...
        doFrame(mTimestampNanos, mFrame); //2 如果此时有耗时操作, 需要等到耗时操作执行完, handler才会处理doFrame()
    }
}
```
...
>
> ![img](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="600" height="183"></svg>)
